...
var combination = [
    ...
    // здравствуйте
    { id: 'здр', options:['авствуйте. Вам необходимо действовать по инструкции '] },
    { id: 'Здр', options:['авствуйте. Вам необходимо действовать по инструкции '] },
    { id: 'здравствуйте', options:['. Вам необходимо действовать по инструкции '] },
    { id: 'Здравствуйте', options:['. Вам необходимо действовать по инструкции '] },
    { id: 'здравствуйте. ', options:['Давайте уточним: \n1. С какого конкретно почтового ящика отправляли письмо \n2. На какой конкретно ящик \n3. Примерное время отправки \n4. Как отправляете(почтовая программа, скрипт на сайте) \nПостараемся Вам помочь'] },
    { id: 'Здравствуйте', options:['Давайте уточним: \n1. С какого конкретно почтового ящика отправляли письмо \n2. На какой конкретно ящик \n3. Примерное время отправки \n4. Как отправляете(почтовая программа, скрипт на сайте)'] },
