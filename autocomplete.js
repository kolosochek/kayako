...
var combination = [
    // здравствуйте
    { id: 'Здравствуйте, Ваш сайт доступен и работает в штатном режиме', options:[', вот что вижу я: \nВозможно Вам следует обновить кэш браузера по инструкции https://help.mail.ru/enmail-help/helpful/cache\nТак же рекомендую обновить подключение к сети интернет(перезагрузить роутер)'] },  
    { id: 'Здр', options:[
        'авствуйте, Ваш сайт доступен и работает в штатном режиме',
        'авствуйте, мы работаем над Вашим запросом, ожидайте, пожалуйста.',
        "авствуйте, пожалуйста, не создавайте несколько заявок сразу."
    ] },
